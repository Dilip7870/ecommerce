    ...
    return (
        <Card sx={{ maxWidth: 330, marginRight: 'auto', marginTop: 5 }}>
            ...
            <CardActions sx={{ display: "flex", flexDirection: "row", justifyContent: "center" }} >
                <LoadingButton variant="outlined" sx={{ marginTop: "auto", color: "#282580", borderColor: "#282580", outlineColor: "#282580" }} fullWidth className="add-to-cart" onClick={(e) => handleClick(e, item)}>
                    ADD TO CART
                </LoadingButton>
            </CardActions>
        </Card>
